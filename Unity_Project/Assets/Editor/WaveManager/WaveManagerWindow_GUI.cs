...
public partial class WaveManagerWindow : EditorWindow {
	...
	void OnGUI()
	{
		...
		if (wave != null) 
		{
			...
			GUILayout.BeginHorizontal ();
			wave.nextWaveWait = GUILayout.Toggle (wave.nextWaveWait, "Next wave will wait"); wave.timeBeforeNextWave = EditorGUILayout.FloatField ("Time before the next wave : ",wave.timeBeforeNextWave);
			GUILayout.EndHorizontal();
